fetch('https://api.nytimes.com/svc/books/v3/lists.json?list-name=hardcover-fiction&api-key=5RKjt3e0qciAQ5iP2TAxmz5WBtZyVBsC', {
    method: 'get',
  })
...
function updateCover(id, isbn) {
  fetch('https://www.googleapis.com/books/v1/volumes?q=isbn:' + isbn + "&key=AIzaSyC03EDKmeX_WwhGxzhPV8jIwJh-Ezq_jBo", {
    method: 'get'
  })
  .then(response => { return response.json(); })
  .then(data => {
